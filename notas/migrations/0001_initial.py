# Generated by Django 5.2.1 on 2025-07-13 21:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion_fisica', models.CharField(blank=True, max_length=255, verbose_name='Dirección Física')),
                ('telefono_contacto', models.CharField(blank=True, max_length=50, verbose_name='Teléfono Principal')),
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='logos_colegios/', verbose_name='Logo Principal del Colegio')),
                ('logo_secundario', models.ImageField(blank=True, help_text='Logo adicional, como el de una gobernación o secretaría de educación.', null=True, upload_to='logos_colegios/', verbose_name='Logo Secundario (Opcional)')),
                ('color_primario', models.CharField(default='#923E2B', max_length=7, verbose_name='Color Primario (Botones, enlaces)')),
                ('color_secundario', models.CharField(default='#4F4F4F', max_length=7, verbose_name='Color Secundario (Fondos, acentos)')),
